...
model=resnet101(num_classes=65)
# 检查修改后的模型结构
print(model)

#
# model=torch.load('F:/Python_venv/Deep_Learning/pythonProject/Metamaterials/ResNet101/model150.pt')
...
for epoch in range(200):
    ...
    torch.save(model, f"./ResNet101.pt")
